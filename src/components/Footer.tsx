        ...
        <div className="grid gap-12 md:grid-cols-3 lg:grid-cols-4">
          <div className="md:col-span-1 lg:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full bg-neutral-800 hover:bg-brand-600 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex flex-col">
                ...
                <a href="https://api.whatsapp.com/send/?phone=5534998121269" className="text-brand-400 hover:text-brand-300 font-medium">(34) 99812-1269</a>
              </li>
